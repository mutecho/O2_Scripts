...
// void ndHistoRead(string rpath, string rfilename, string wpath, string
// wfilename)
// {
//     // string fullpath = filepath + "/" +filename;
//     auto rfFemtoep = GetROOT(rpath, rfilename, "read");
//     auto wfFemtoep = GetROOT(wpath, wfilename, "recreate");
//     auto h4 =
//     (THnSparseF*)rfFemtoep->Get("FemtoDreamRec_EP/relPairkstarmTMultMultPercentileQn");
...
//     // 定义中心度和 mT 区间
//     std::vector<std::pair<double,double>> centBins = {{0,10}, {10,30},
//     {30,50}}; std::vector<std::pair<double,double>> mTBins   = {{0.5,0.7},
//     {0.7,1.0}, {1.0,1.5}};
...
//             // 创建新的画布
//             string cname = "c_cent=" + centLow+"-"+centHigh+" mT" +
//             mTLow+"-"+mTHigh; TCanvas *c = new TCanvas(cname, cname, 800,
//             600); c->SetMargin(0.13, 0.05, 0.12, 0.07); c->SetGrid();
...
void ReadSME_phi() {
  string rpath1 = "/Users/allenzhou/ALICE/scripts/femtoep";
  string rfilename1 = "AnalysisResults_femtoep_sm";
  string rpath2 = "/Users/allenzhou/ALICE/scripts/femtoep";
  string rfilename2 = "AnalysisResults";
  string wpath = "/Users/allenzhou/ALICE/scripts/femtoep";
  string wfilename1 = "Check EP mixing 1";
